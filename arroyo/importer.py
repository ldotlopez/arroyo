...
class OriginSpec(utils.InmutableDict):
    ...
    Instances of OriginSpec are used to get a configured Origin from Importer.
    """
...
class Importer:
    ...
    def get_origins(self):
        ...
        This list is composed by Origin objects.
        """
    ...
    def get_origins_specs(self):
        ...
        This list is composed by OriginSpec objects which are data-only
        structures. To get some usable object you may want to use
        Importer.get_origins method
        """
    ...
    def get_origins_for_query_spec(self, query_spec):
        """Get autogenerated origins for a QuerySpec object.

        One query can produce zero or more or Origins from the activated
        origin extensions.
